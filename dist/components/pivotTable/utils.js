...
function insertNode(tree, layerKeys, nodeData, depth, collapsedKeyList, sort) {
...
export function buildNestTree(layerKeys, data, collapsedKeyList, showSummary, sort, dataWithoutSort) {
    const tree = {
        key: ROOT_KEY,
        value: 'root',
        fieldKey: 'root',
