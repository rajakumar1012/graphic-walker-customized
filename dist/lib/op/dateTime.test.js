...
describe('drill', () => {
    test('year', () => {
        ...
        expect(bind(date, result.map((x) => new Date(x).toISOString()))).toEqual(bind(date, [
    ...
    test('quarter', () => {
        const { result } = dateTimeDrill('result', getParams('quarter'), { date });
        expect(bind(date, result.map((x) => new Date(x).toISOString()))).toEqual(bind(date, [
            '2010-01-01T00:00:00.000Z',
...
describe('feature', () => {
    ...
    test('minute', () => {
        ...
        expect(bind(date, result)).toEqual(bind(date, [41, 21, 38, 55, 23, 45, 53, 33, 49, 6, 11, 42, 45, 33, 39, 9, 25, 45, 33, 1, 3, 22, 38, 14, 54, 43, 45]));
    });
    test('second', () => {
    ...
    test('iso_year', () => {
        ...
        expect(bind(date, result)).toEqual(bind(date, [
