...
export function availableChannels(geomType) {
    if (geomType === 'text') {
...
export function channelEncode(props) {
    ...
    Object.keys(props)
        ...
        if (field !== NULL_FIELD) {
            ...
            if (c === 'color' && field.expression?.op === 'paint') {
                const map = field.expression.params.find((x) => x.type === 'map' || x.type === 'newmap').value;
