...
function fillColorConfig(config, baseColors) {
    return {
        ...baseColors,
        ...{
...
export function ColorConfigToCSS(config) {
...
export function getColorConfigFromPalette(colors) {
    return {
        light: {
            background: 'white',
...
export const zincTheme = getColorConfigFromPalette(colors.zinc);
export const slateTheme = getColorConfigFromPalette(colors.slate);
export const grayTheme = getColorConfigFromPalette(colors.gray);
export const neutralTheme = getColorConfigFromPalette(colors.neutral);
export const stoneTheme = getColorConfigFromPalette(colors.stone);
